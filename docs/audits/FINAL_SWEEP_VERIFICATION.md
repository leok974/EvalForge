...
| `playwright_ignition.json` | `student` | ✅ (Expected) | 0/7 | |
| `playwright_systems.json` | `solution` | ✅ | 4/4 | |
| `playwright_systems.json` | `student` | ✅ (Expected) | 1/4 | |
