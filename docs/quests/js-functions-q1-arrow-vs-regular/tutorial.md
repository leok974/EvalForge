...
> [!NOTE]
> **What you'll build:** Practice js functions q1 arrow vs regular concepts in a real-world scenario.

---

## 1) What You'll Build
In this quest, you'll work with js functions q1 arrow vs regular to practice core concepts.
