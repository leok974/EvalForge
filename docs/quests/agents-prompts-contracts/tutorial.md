...
In this quest, you'll work with agents prompts contracts to practice core TYPESCRIPT concepts.
...
SELECT * FROM users; -- Example code for agents-prompts-contracts
```
