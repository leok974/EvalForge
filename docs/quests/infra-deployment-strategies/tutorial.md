...
In this quest, you'll work with infra deployment strategies to practice core BASH concepts.
...
SELECT * FROM users; -- Example code for infra-deployment-strategies
```
