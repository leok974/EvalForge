...
In this quest, you'll work with js async q1 promises basics to practice core JavaScript concepts.
...
console.log("Example code for js-async-q1-promises-basics");
```
