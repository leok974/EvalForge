...
> [!NOTE]
> **What you'll build:** Practice js control q1 if else loops concepts in a real-world scenario.

---

## 1) What You'll Build
In this quest, you'll work with js control q1 if else loops to practice core concepts.
