...
> [!NOTE]
> **What you'll build:** Practice js ignition q1 console and functions concepts in a real-world scenario.

---

## 1) What You'll Build
In this quest, you'll work with js ignition q1 console and functions to practice core concepts.
