...
try:
    ...
    title_element = driver.find_element(By.CSS_SELECTOR, "[data-testid='dashboard-title']")
    title_text = title_element.text
    
    assert "Welcome, Admin" in title_text
    print(f"Verified: Dashboard Title is '{title_text}'")
finally:
    driver.quit()
